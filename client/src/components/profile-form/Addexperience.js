...
const Addexperience =({addExperience,history})=>{
    ...
    return(
      ...
      <form className="form" onSubmit={e=>{
        ...
        <div className="form-group">
          <input type="text" placeholder="* Company" name="companyname" value={companyname} onChange={e=> handleChange(e)}required />
        </div>
        <div className="form-group">
        ...
        <div className="form-group">
         ...
         <div className="form-group">
          <p><input type="checkbox" name="current" checked ={current} value={current} onChange={e=> {setFormData({...formData, current:!current});toggletoDate(!toDateDisabled)}}/> Current Job</p>
        </div>
        <div className="form-group">
          <h4>To Date</h4>
        ...
        <div className="form-group">
          <textarea
            ...
            value={description} onChange={e=> handleChange(e)}></textarea>
        </div>
